...
export function DebugHandOverlay({ leftHand, rightHand, status, gesture }) {
  ...
  useEffect(() => {
    ...
    const drawHand = (landmarks, color, label) => {
      if (!landmarks) return
    ...
    // Draw both hands
    drawHand(leftHand, '#00ff00', 'LEFT')
    drawHand(rightHand, '#ff00ff', 'RIGHT')
  ...
  }, [leftHand, rightHand, gesture, status])
